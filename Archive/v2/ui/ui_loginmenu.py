...
class Ui_loginMenu(object):
    ...
    def retranslateUi(self, loginMenu):
        ...
        self.btn_user5.setText(_translate("loginMenu", "User 5"))
        self.btn_user6.setText(_translate("loginMenu", "User 6"))
        self.btn_user1.setText(_translate("loginMenu", "User 1"))
        self.btn_user2.setText(_translate("loginMenu", "User 2"))
        self.btn_user3.setText(_translate("loginMenu", "User 3"))
        self.btn_user4.setText(_translate("loginMenu", "User 4"))
        self.btn_back.setText(_translate("loginMenu", "Back"))
        self.btn_newLogin.setText(_translate("loginMenu", "New User"))
