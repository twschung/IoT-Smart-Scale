...
class Ui_foodInformation(object):
    def setupUi(self, foodInformation):
        ...
        self.gridLayout = QtWidgets.QGridLayout(foodInformation)
        ...
        self.gridLayout.addWidget(self.frame_lcd, 2, 0, 3, 2)
        ...
        self.gridLayout.addWidget(self.btn_tare, 2, 2, 2, 1)
        ...
        self.gridLayout.addWidget(self.btn_addIntake, 2, 3, 2, 1)
        ...
        self.gridLayout.addWidget(self.btn_new, 4, 2, 1, 1)
        ...
        self.pic_foodItem = QtWidgets.QGraphicsView(foodInformation)
        self.pic_foodItem.setMinimumSize(QtCore.QSize(441, 271))
        self.pic_foodItem.setFrameShadow(QtWidgets.QFrame.Raised)
        self.pic_foodItem.setObjectName("pic_foodItem")
        self.gridLayout.addWidget(self.pic_foodItem, 1, 0, 1, 3)
        ...
        self.gridLayout.addWidget(self.grpBx_nutriInfo, 1, 3, 1, 1)
