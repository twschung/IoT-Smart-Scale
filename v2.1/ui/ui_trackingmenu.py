...
class Ui_trackingMenu(object):
    def setupUi(self, trackingMenu):
        ...
        self.lbl_todayCompare = QtWidgets.QLabel(self.tab_dailyRecord)
        self.lbl_todayCompare.setObjectName("lbl_todayCompare")
        self.gridLayout_2.addWidget(self.lbl_todayCompare, 2, 0, 1, 1)
        self.label_2 = QtWidgets.QLabel(self.tab_dailyRecord)
    ...
    def retranslateUi(self, trackingMenu):
        ...
        self.lbl_todayCompare.setText(_translate("trackingMenu", "100/1200kcal"))
        self.label_2.setText(_translate("trackingMenu", "100/1200kcal"))
