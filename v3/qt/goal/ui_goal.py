...
class Ui_goal(object):
    def setupUi(self, goal):
        ...
        self.lbl_targetWeight.setMinimumSize(QtCore.QSize(50, 20))
        font = QtGui.QFont()
        font.setFamily("Arial")
        ...
        self.lineEdit_targetWeight = QtWidgets.QLineEdit(self.groupBox)
        self.lineEdit_targetWeight.setMinimumSize(QtCore.QSize(513, 19))
        font = QtGui.QFont()
        font.setFamily("Arial")
        self.lineEdit_targetWeight.setFont(font)
        self.lineEdit_targetWeight.setObjectName("lineEdit_targetWeight")
        self.formLayout.setWidget(0, QtWidgets.QFormLayout.FieldRole, self.lineEdit_targetWeight)
        self.lbl_recommendedWeight = QtWidgets.QLabel(self.groupBox)
        self.lbl_recommendedWeight.setMinimumSize(QtCore.QSize(61, 19))
        font = QtGui.QFont()
        font.setFamily("Arial")
        ...
        self.lbl_recommendedWeightVal.setMinimumSize(QtCore.QSize(513, 20))
        font = QtGui.QFont()
        font.setFamily("Arial")
        ...
        self.lbl_targetIntake.setMinimumSize(QtCore.QSize(80, 20))
        font = QtGui.QFont()
        font.setFamily("Arial")
        ...
        self.lineEdit_targetIntake = QtWidgets.QLineEdit(self.groupBox)
        self.lineEdit_targetIntake.setMinimumSize(QtCore.QSize(513, 19))
        font = QtGui.QFont()
        font.setFamily("Arial")
        self.lineEdit_targetIntake.setFont(font)
        self.lineEdit_targetIntake.setObjectName("lineEdit_targetIntake")
        self.formLayout.setWidget(2, QtWidgets.QFormLayout.FieldRole, self.lineEdit_targetIntake)
        self.lbl_recommendedIntake = QtWidgets.QLabel(self.groupBox)
        self.lbl_recommendedIntake.setMinimumSize(QtCore.QSize(55, 19))
        font = QtGui.QFont()
        font.setFamily("Arial")
        ...
        self.lbl_recommendedIntakeVal.setMinimumSize(QtCore.QSize(513, 20))
        font = QtGui.QFont()
        font.setFamily("Arial")
    ...
    def retranslateUi(self, goal):
        ...
        self.lbl_recommendedWeightVal.setText(_translate("goal", "lbl_recommendedWeightVal"))
