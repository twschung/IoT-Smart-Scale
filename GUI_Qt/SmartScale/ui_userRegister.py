...
class Ui_userRegister(object):
    def setupUi(self, userRegister):
        ...
        self.txtHeight = QtWidgets.QTextEdit(self.scrollAreaWidgetContents)
        self.txtHeight.setGeometry(QtCore.QRect(130, 320, 621, 31))
        self.txtHeight.setObjectName("txtHeight")
        self.txtFirstname = QtWidgets.QTextEdit(self.scrollAreaWidgetContents)
        ...
        self.txtLastname = QtWidgets.QTextEdit(self.scrollAreaWidgetContents)
        ...
        self.txtWeight = QtWidgets.QTextEdit(self.scrollAreaWidgetContents)
        self.txtWeight.setGeometry(QtCore.QRect(130, 360, 621, 31))
        self.txtWeight.setObjectName("txtWeight")
        self.txtConfirmPassword = QtWidgets.QTextEdit(self.scrollAreaWidgetContents)
        self.txtConfirmPassword.setGeometry(QtCore.QRect(130, 90, 621, 30))
        self.txtConfirmPassword.setObjectName("txtConfirmPassword")
        self.txtEmail = QtWidgets.QTextEdit(self.scrollAreaWidgetContents)
        ...
        self.txtUsername = QtWidgets.QTextEdit(self.scrollAreaWidgetContents)
        ...
        self.txtPassword = QtWidgets.QTextEdit(self.scrollAreaWidgetContents)
        ...
        self.lblConfirmPassword.raise_()
        self.datDoB.raise_()
        ...
        self.txtConfirmPassword.raise_()
    ...
    def retranslateUi(self, userRegister):
        ...
        self.lblStatus.setText(_translate("userRegister", "Please enter the following details:"))
